...
export const ResetPassword = () => {
    ...
    useEffect(()=>{
        ...
        console.log(data)
        axios.post("https://nodejs-day5-be.onrender.com/ForgotPassword/RandomString",data).then((res)=>{
    ...
    function passwordReset(e){
        ...
        if(newPassword.current.value===confirmNewPassword.current.value){
            ...
            axios.post("https://nodejs-day5-be.onrender.com/ForgotPassword/ResetPassword",data).then((res)=>{
